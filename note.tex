...
\title{\centering Calculo Volume 1 9Ed}
...
{\centering \includegraphics[width=5cm]{./res/ebook.jpg} \par}
...
O que é uma função \dotfill $\begin{aligned}{\centering \includegraphics[width=7cm]{./res/image1.png}}\end{aligned}$\\ 
Faça o diagrama de máquina para uma função\dotfill$\begin{aligned}{\centering \includegraphics[width=7cm]{./res/image2.png}}\end{aligned}$\\
Defina: $\begin{aligned}{\centering \includegraphics[width=7cm]{./res/image3.png}}\end{aligned}$\dotfill$\begin{aligned}{\centering \includegraphics[width=7cm]{./res/image4.png}}\end{aligned}$\\ 
Defina: $\begin{aligned}{\centering \includegraphics[width=7cm]{./res/image6.png}}\end{aligned}$\dotfill$\begin{aligned}{\centering \includegraphics[width=7cm]{./res/image5.png}}\end{aligned}$\\
...
Defina função par ou ímpar $\begin{aligned}{\centering \includegraphics[width=4cm]{./res/image7.png}}\end{aligned}$\dotfill par\\ 
Defina função par ou ímpar $\begin{aligned}{\centering \includegraphics[width=4cm]{./res/image8.png}}\end{aligned}$\dotfill ímpar\\ 
...
faca o diagrama de funcao composta:\dotfill$\begin{aligned}{\centering \includegraphics[width=5cm]{./res/image9.png}}\end{aligned}$\\
